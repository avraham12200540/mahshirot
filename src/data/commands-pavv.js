...
export const PAVV_CATEGORIES = [
  ...
  {
    id: "pavv-6",
    name: "הגנות וסינון (MDM) (פב״ב הראשון)",
    icon: "shield",
    commands: [
      {
        id: "pavv-6-1",
  ...
  {
    id: "pavv-9",
    name: "MDM ו-Device Owner — ניהול מכשיר ארגוני (פב״ב הראשון)",
    icon: "lock",
    commands: [
      {
        id: "pavv-9-1",
        label: "הגדרת Device Owner",
      ...
      },
      {
        ...
        tip: "בצרנים ישנים (לפני Android 8) פתיחת ה-Bootloader בוצעה דרך פקודה זו במקום fastboot flashing unlock. ב-Android 8+ השתמש ב-fastboot flashing unlock (קטגוריה 9). פקודה זו עדיין שימושית על Motorola / OnePlus ישנים.",
