...
export function openAboutModal() {
  const body = el("div", {}, [
    ...
    el("p", {
      html: `תודה מיוחדת ל<strong>פב״ב הראשון</strong>, ולעוד הרבה משתמשים שתרמו פקודות, תיקונים ומשוב שעזרו לאתר להגיע למקום שהוא נמצא בו היום. אוסף הפקודות המורחב שתרם אפשר למצוא תחת <strong>״עוד קטגוריות״</strong> בעמוד הראשי — משולב באותו עיצוב וניתן להרצה כמו כל פקודה אחרת באתר.`,
    }),
  ]);
