/**
 * אייקונים — SVG inline (מבוסס Lucide, stroke-based).
 * שימוש: icon("plug") מחזיר מחרוזת SVG.
 */
...
const PATHS = {
  ...
  battery:
    '<rect width="16" height="10" x="2" y="7" rx="2"/><path d="M22 11v2"/>',
